...
namespace AppCore.Business.Abstracts.Services.Identity
{
    public interface IIdentityService
    {
        ...
        Result<List<IdentityClaimModel>> GetParentClaims();
        Result<List<IdentityClaimModel>> GetParentAndChildClaims(int parentId);
        Result<List<IdentityClaimModel>> GetParentAndChildClaimsByGuid(string parentGuid);
        Result<List<IdentityClaimModel>> GetParentAndChildClaimsByType(string parentType);
        Result<List<IdentityClaimModel>> GetParentClaimsByType(string parentType);
        Result<List<IdentityClaimModel>> GetChildClaims(int parentId);
